...
这是 **Listen Music Together** 项目的Windows音频后端模块，使用C++和Windows WASAPI（Windows Audio Session API）实现。该模块提供了完整的音频会话管理、音量控制、静音控制以及音频数据捕获功能。
...
2. **音量混音器** - 独立控制每个应用的音量
3. **音频监控工具** - 实时监控系统音频会话
4. **音频录制工具** - 捕获系统或特定应用的音频输出
5. **协作听音** - Listen Music Together项目的核心音频后端
